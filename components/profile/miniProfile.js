    ...
    <div className='p-4 w-1/2 transition ease-in-out duration-500 scale-0' ref={ref} style={{ transform: `scale(${scale})` }}>
      <div className="h-full flex flex-col lg:flex-row items-center justify-center text-left">
        <Link legacyBehavior href={props.link ? props.link : "#"}>
          <img alt="team" className="flex-shrink-0 rounded-lg w-36 h-36 md:w-48 md:h-48 object-cover object-center mb-4 lg:mb-0 cursor-pointer" src={props.img ? props.img : "https://dummyimage.com/200x200"} />
        </Link>
        <div className="flex-grow sm:pl-8">
          ...
          <p className="mb-1">Phone: <a href={`tel:${props.number}`} >{props.number}</a></p>
