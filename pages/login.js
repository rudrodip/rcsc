      ...
      <div className='overflow-y-hidden'>
        ...
        <div className="min-h-screen flex flex-col">
          <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
            <div className="bg-gradient-to-r from-blue-800 to-blue-600 px-6 py-8 rounded-xl shadow-md text-black w-full">
              ...
              <button
                type="submit"
                className="w-full text-center py-3 rounded-xl bg-gradient-to-r from-blue-400 to-cyan-400 text-white hover:scale-105 transition duration-200 focus:outline-none my-1"
