      ...
      <section className="about_desc">
        ...
        <div className='w-full lg:w-3/4 p-3 lg:m-auto my-4 lg:my-10 text-left'>
          ...
          <p className='font-medium text-white'>
            বর্তমানে ক্লাবের বিভিন্ন কার্যক্রম পরিচালনার জন্য রয়েছে ১০ সদস্য বিশিষ্ট এক্সিকিউটিভ কমিটি এবং তাদের সাথে ১০ জন কুয়েরিস্ট মেম্বার। ক্লাবের কনভেনর পদার্থবিজ্ঞান বিভাগের সহযোগী অধ্যাপক মোঃ আলাউদ্দিন স্যারের নেতৃত্বে  বর্তমানে ক্লাবের সকল কার্যক্রম পরিচালনা করা হয়।
          </p>
        </div>
      </section>
      <section>
